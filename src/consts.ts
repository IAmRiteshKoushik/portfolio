...
export const HOME: Metadata = {
  TITLE: "Home",
  DESCRIPTION: "Ritesh Koushik is a Go developer interested in distributed systems and storage engines.",
};
...
export const BOOKS: Metadata = {
  TITLE: "Books",
  DESCRIPTION: "A simple reading list of books worth keeping close.",
};

export const WEEKNOTES: Metadata = {
  TITLE: "Weeknotes",
